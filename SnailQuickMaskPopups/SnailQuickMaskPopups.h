...
// 弹出样式（仅当设置`SnailPopupsPresentationStyle`为`SnailPopupsPresentationStyleCentered`时，以下效果才会生效）
...
@property (nonatomic, assign) SnailPopupsTransitionStyle transitionStyle;       // 弹出效果
